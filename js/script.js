...
createApp({
    ...
    methods: {
        ...
        addChat: function(){
            if (this.newChatName.trim().length > 0 && this.newChatImg.trim().length > 0){
                // {
                //     name: 'Michele',
                //     avatar: './img/avatar_1',
                //     visible: true,
                ...
                let newChat = {name : this.newChatName.trim(), avatar: this.newChatImg.trim(), visible : true, messages : []};
